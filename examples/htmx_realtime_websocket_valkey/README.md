...
This standalone app runs a Litestar page with Valkey queue persistence plus memory Channels delivery.
...
Set LITESTAR_QUEUES_EXAMPLE_VALKEY_URL when Valkey is not available at redis://localhost:6379/0.
