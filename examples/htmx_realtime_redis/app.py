...
# -- docs-task-start --
@task("examples.htmx_realtime_redis.crawl", queue="demo", retries=0, timeout=90)
...
queue_config = QueueConfig(
    queue_backend=RedisBackendConfig(url=REDIS_URL, key_prefix="litestar_queues:examples:htmx_realtime_redis"),
    event=EventConfig(
        enabled=True,
