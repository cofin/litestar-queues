...
code. Queue persistence runs through Advanced Alchemy with `sqlite+aiosqlite`,
...
(`EventStreamConfig(scopes={"task"}, allow_unauthenticated=True)`). This local demo does not add
