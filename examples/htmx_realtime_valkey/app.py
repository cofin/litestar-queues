...
# -- docs-task-start --
@task("examples.htmx_realtime_valkey.crawl", queue="demo", retries=0, timeout=90)
...
queue_config = QueueConfig(
    queue_backend=ValkeyBackendConfig(url=VALKEY_URL, key_prefix="litestar_queues:examples:htmx_realtime_valkey"),
    event=EventConfig(
        enabled=True,
